...
<div class="card col-sm-8">
  <h5 class="card-body h6">CHECKER DE CC by @carlonch5</h5>
  <div class="card-body">
    <center><span>[INFO CC]</span></center>
<div class="md-form">
	<div class="col-md-12">
  <textarea type="text" style="text-align: center;" id="lista" class="md-textarea form-control" rows="2"></textarea>
  <label for="lista">FORMATO 0000000000000000|00|0000|000</label>
</div>
</div>
<center>
...
<div class="card col-sm-2">
  <h5 class="card-body h6">información:</h5>
  <div class="card-body">
  	<span>Status:</span><span class="badge badge-secondary"> Aguardando  comando.</span>
<div class="md-form">
...
<footer >
    ...
    <div class="footer-copyright text-center py-3">Editado por :
      <a href="https://web.telegram.org//"> @carlonch5 </a>
    </div>
